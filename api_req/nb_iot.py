...
url = "http://api.sim.telecom.com.ar/api/v3/proyecto/NB_IOT"
...
jfile = open('C:\\Users\\u565589\\Documents\\indmovil\\SpyderProy\\sim_bajadas\\NB.json', 'w')
...
f = open('C:\\Users\\u565589\\Documents\\indmovil\\SpyderProy\\sim_bajadas\\NB.csv', 'w', newline="")
write = csv.writer(f)
