...
url = "http://api.sim.telecom.com.ar/api/v3/proyecto/ActivacionLTE850"
...
jfile = open('C:\\Users\\u565589\\Documents\\indmovil\\SpyderProy\\sim_bajadas\\LTE850.json', 'w')
...
f = open('C:\\Users\\u565589\\Documents\\indmovil\\SpyderProy\\sim_bajadas\\LTE850.csv', 'w', newline="")
write = csv.writer(f)
